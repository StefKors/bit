...
export const makePR = (opts: MockPROptions = {}) => {
  ...
  return {
    ...
    mergeable: null,
    mergeableState: null,
    authorLogin: "authorLogin" in opts ? opts.authorLogin : "user1",
    authorAvatarUrl: "authorAvatarUrl" in opts ? opts.authorAvatarUrl : null,
    headRef: "feature",
    headSha: "abc",
    baseRef: "main",
    baseSha: "def",
    ...
    labels: "labels" in opts ? opts.labels : null,
