...
export const schema = i.schema({
  entities: {
    ...
    commitStatuses: i.entity({
      statusKey: i.string().unique().indexed(),
      githubId: i.number().optional().indexed(),
      nodeId: i.string().optional(),
      sha: i.string().indexed(),
      context: i.string().optional().indexed(),
      state: i.string().optional().indexed(),
      description: i.string().optional(),
      targetUrl: i.string().optional(),
      url: i.string().optional(),
      creatorLogin: i.string().optional().indexed(),
      creatorAvatarUrl: i.string().optional(),
      branch: i.string().optional().indexed(),
      payload: i.string().optional(),
      createdAt: i.number(),
      updatedAt: i.number().indexed(),
    ...
    workflowRuns: i.entity({
      githubId: i.number().unique().indexed(),
      workflowId: i.number().optional().indexed(),
      nodeId: i.string().optional(),
      name: i.string().optional().indexed(),
      ...
      conclusion: i.string().optional().indexed(),
      htmlUrl: i.string().optional(),
      runNumber: i.number().optional().indexed(),
      runAttempt: i.number().optional().indexed(),
      headSha: i.string().optional().indexed(),
      headBranch: i.string().optional().indexed(),
      runStartedAt: i.number().optional(),
      githubCreatedAt: i.number().optional(),
    ...
    workflowJobs: i.entity({
      githubId: i.number().unique().indexed(),
      runId: i.number().optional().indexed(),
      nodeId: i.string().optional(),
      name: i.string().optional().indexed(),
      status: i.string().optional().indexed(),
      conclusion: i.string().optional().indexed(),
      htmlUrl: i.string().optional(),
      runUrl: i.string().optional(),
      headSha: i.string().optional().indexed(),
      startedAt: i.number().optional(),
      completedAt: i.number().optional(),
      stepCount: i.number().optional(),
      payload: i.string().optional(),
      createdAt: i.number(),
      updatedAt: i.number().indexed(),
    }),
  ...
  links: {
    ...
    pullRequestCommitStatusesLink: {
      ...
      reverse: {
        on: "pullRequests",
        has: "many",
        label: "commitStatuses",
      },
    },
    pullRequestWorkflowRunsLink: {
      forward: {
        on: "workflowRuns",
        has: "one",
        label: "pullRequest",
